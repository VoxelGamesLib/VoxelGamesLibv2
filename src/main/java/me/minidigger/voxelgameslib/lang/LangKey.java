...
public enum LangKey {
  ...
  GAME_STARTING("{green}The game is about to start"), GAME_START_ABORTED(
      "{red}Game start aborted!"),
  ...
  VOTE_MESSAGE_MAP("{aqua}#{yellow}{num}{aqua}: {yellow}{name}{aqua} by {yellow}{author}", "num",
      "name", "author"),
