...
public class NoBlockPlaceFeature extends AbstractFeature {
   ...
   * place only materials which are on the whitelist. to disabled the whitelist, pass an empty
   * array.
   *
   ...
   * place every material other than those on the blacklist. to disabled the blacklist, pass an
   * empty array
   *
