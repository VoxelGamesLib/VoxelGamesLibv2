...
public enum LangKey implements Translatable {
    ...
    GAME_COULD_NOT_START("{red}Could not enable game!"),
    ...
    GAME_START_ABORTED("{red}Game enable aborted!"),
    ...
    GAME_STOP_IN_NO_GAME_SPEC("{red}You don't spectate any game. Can't disable"),
    ...
    WORLD_MODIFY_NOT_STARTED("{red}You need to enable the world modifier using {yellow}/wc m enable {red}first"),
