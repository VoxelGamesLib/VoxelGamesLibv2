...
/**
 * This is a chainable builder for {@link ItemStack}s in {@link Bukkit} <br> Example Usage:<br> {@code ItemStack is =
 * new ItemBuilder(Material.LEATHER_HELMET).amount(2).data(4).durability(4).enchantment(Enchantment.ARROW_INFINITE).enchantment(Enchantment.LUCK,
