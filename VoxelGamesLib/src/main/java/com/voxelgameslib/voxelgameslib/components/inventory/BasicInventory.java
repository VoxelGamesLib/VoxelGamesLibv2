...
/**
 * A basic inventory is a type of inventory. <p> It has only one page. Clicking an item will perform an action. There
 * will be no extra pages other than the single inventory page.
 */
