 ...
 * {@link GameMode}: starting, stopping, {@link Phase}s etc.
 */
public interface Game extends Tickable {
    ...
    /**
     * @return the game definition for this gamemode, generated by the phases and features this game currently has
     */
    @Nonnull
    ...
    /**
     * Sends a message to everr User that is related to this game. This could be a participant in the game or a
     * spectator.
     *
     ...
     */
    com.voxelgameslib.voxelgameslib.internal.persistence.model.GameData getGameData(@Nullable User winner, @Nullable Team winners);
}
